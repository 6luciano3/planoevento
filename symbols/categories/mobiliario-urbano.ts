...
export const MOBILIARIO_URBANO: DefinicionSimbolo[] = [
  ...
  { id: "iso-bolardo-luminoso", nombre: "Bolardo luminoso", categoria: "mobiliario-urbano", icono: "/symbols/Iluminación, energía y servicios técnicos/03_bolardo_luminoso.png", prefijo: "MU", defaultWidth: 0.4, defaultHeight: 0.4, unit: "m", rotatable: false, resizable: true, estiloIcono: "isometrico" },
  { id: "iso-banco-urbano", nombre: "Banco urbano", categoria: "mobiliario-urbano", icono: "/symbols/circulación y orientación/Banco urbano.png", prefijo: "MU", defaultWidth: 2, defaultHeight: 0.8, unit: "m", rotatable: false, resizable: true, estiloIcono: "isometrico" },
];
